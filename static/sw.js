...
const CACHE_NAME = 'odysseus-v464-runinspector2';
...
const PRECACHE = [
  ...
  '/static/js/chat.js?v=20260923contextwindow1',
  ...
  '/static/js/chat-run-inspector.js?v=20260923runinspector2',
