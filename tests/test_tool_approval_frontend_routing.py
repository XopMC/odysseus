...
def test_every_changed_approval_module_is_cache_busted_together():
    ...
    assert "chatStream.js?v=20260925teamstart3" in index
    assert "chatStream.js?v=20260925teamstart3" in chat
    ...
    assert "chatRenderer.js?v=20260925teamstart3" in compare_stream
