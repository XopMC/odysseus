...
def test_route_context_agent_frontend_and_cache_bust_wire_the_contract():
    ...
    assert "chat.js?v=20260923context1" in app
    assert "chat.js?v=20260923context1" in index
    assert "chatRenderer.js?v=20260923lazy2" in frontend
    assert "chatRenderer.js?v=20260923lazy2" in app
    assert "chatRenderer.js?v=20260923lazy2" in index
