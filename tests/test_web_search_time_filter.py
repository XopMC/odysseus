...
# conftest initializes the real tool package. Evicting it during collection
# splits the execution module from functions already imported by agent_loop,
# causing subsequent dispatch tests to execute real tools instead of their mocks.
