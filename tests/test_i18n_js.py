...
def test_full_authored_menu_inventory_and_per_user_browser(tmp_path):
    ...
    script = r"""
      ...
      try{
        ...
        assert.deepEqual(await page.evaluate(()=>approvalResult),{decision:'approve_once',label:'Allow once'});
        await page.evaluate(async()=>{
