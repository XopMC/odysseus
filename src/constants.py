...
TEAM_DB = os.path.join(DATA_DIR, "teams.db")
ENGINEERING_PROBE_MAX_TOKENS = 256
ENGINEERING_PROBE_TIMEOUT_SECONDS = 35
TEAM_MAX_WORKERS = 4
TEAM_MAX_OUTPUT_TOKENS = 4096
TEAM_CONTEXT_LIMIT = 32768
