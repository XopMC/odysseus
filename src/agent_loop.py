...
def build_active_plan_note(approved_plan: str) -> str:
    ...
    return (
        ...
        "create files, or call tools outside the current steps merely because an "
        "earlier draft mentioned them. Work through the current plan IN ORDER. "
        "For the Python tool, use print(...) when the step requires a value in stdout. "
        "After finishing and checking each step, call "
