...
DEFAULT_SETTINGS = {
    ...
    "goal_max_wall_seconds": 0,  # 0 = unlimited; checked at safe model/tool boundaries
    "agent_max_children_per_run": 0,  # 0 = unlimited; completed/removed children still count
