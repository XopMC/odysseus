                    ...
                    try:
                        if data.strip():
                            if data.startswith("{"):
                                ...
                                # Usage/stats and generated output are independent
                                # fields: some local OpenAI-compatible servers
                                # (including LM Studio builds) attach usage and
                                # timings to the same final frame as the last
                                # content delta. Process both below; filtering usage
