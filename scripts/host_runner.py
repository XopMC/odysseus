...
class Runner:
    ...
    def _file(self, op, args, owner, scope):
        ...
        if op == 'file.call':
            ...
            if tool not in {'read_file', 'write_file', 'edit_file', 'apply_patch', 'ls', 'glob', 'grep', 'search_files', 'list_tree', 'file_outline', 'git_status', 'git_diff', 'git_log', 'compare_files', 'verify_hashes', 'inspect_toolchain', 'get_workspace'}:
